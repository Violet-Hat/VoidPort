...
{
    [LegacyName("VoidChest2")]
	[LegacyName("VoidChest3")]
	[LegacyName("VoidChest4")]
	public class VoidChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(60, 55, 70), name);
			DustType = DustID.Bone;
			RegisterItemDrop(ModContent.ItemType<VoidChestItem>());
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<VoidChestItem>();
