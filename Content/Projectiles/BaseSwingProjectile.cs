...
namespace VoidPort.Content.Projectiles
{
    //Slight modification of Example Mod's ExampleSwingingEnergySwordProjectile
    public class BaseSwingProjectile : ModProjectile
    {
        public virtual float ScaleMulti => 0.6f;
        ...
        public virtual Color DrawColorBack => Color.White;
        public virtual Color DrawColorMiddle => Color.White;
        public virtual Color DrawColorFront => Color.White;
        ...
        public override void AI()
        {
            ...
            {
				Color dustColor = Color.Lerp(ParticleColor1, ParticleColor2, Main.rand.NextFloat() * 0.3f);
            ...
            {
				Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, ParticleColor1 * Projectile.Opacity, 1.2f * Projectile.Opacity);
			}
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			Color backDarkColor = DrawColorBack;
			Color middleMediumColor = DrawColorMiddle;
			Color frontLightColor = DrawColorFront;
